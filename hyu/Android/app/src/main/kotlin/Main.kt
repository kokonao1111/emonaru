...
internal val logger: SkipLogger = SkipLogger(subsystem = "hyu.skip", category = "HyuSkip")

private typealias AppRootView = HyuSkipRootView
private typealias AppDelegate = HyuSkipAppDelegate
